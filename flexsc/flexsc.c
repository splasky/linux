...
static void flexsc_work_handler(struct work_struct *work)
{
    ...
    long arg0 = entry->regs->di;
    long arg1 = entry->regs->si;
    long arg2 = entry->regs->dx;
    long arg3 = entry->regs->r10;
    long arg4 = entry->regs->r8;
    long arg5 = entry->regs->r9;
